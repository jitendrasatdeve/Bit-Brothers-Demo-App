...
import com.example.bitbrothers.databinding.ActivitySignUpBinding;
import com.example.bitbrothers.models.Users;
        ...
        binding.btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                auth.createUserWithEmailAndPassword
                        (binding.etEmail.getText().toString(),binding.etPassoword.getText().toString()).
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            Users user = new Users(binding.etUserName.getText().toString(),binding.etEmail.getText().toString(),
                                    binding.etPassoword.getText().toString());
